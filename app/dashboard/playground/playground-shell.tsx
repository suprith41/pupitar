  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: 6,
        background: hovered && !disabled ? "#FBFCFF" : T.surface,
        color: disabled ? "#A0A8B3" : T.ink,
        fontFamily: T.dm,
        fontSize: 14,
        fontWeight: 400,
  ...
  return (
    <button
      ...
      style={{
        ...
        padding: "0 10px",
        border: "none",
        background: hovered && !disabled ? "#F2F5FA" : "transparent",
        color: disabled ? "#A9B0BC" : T.ink,
        fontFamily: T.dm,
        fontSize: 14,
        fontWeight: 500,
        cursor: disabled ? "not-allowed" : "pointer",
        ...
        >
          ...
          <button
            ...
            style={{
              height: 36,
              padding: "0 24px",
              background: variant.isRunning ? "#1C1C1C" : T.ink,
              color: "#fff",
              border: "none",
              borderRadius: 6,
              fontFamily: T.dm,
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              borderRadius: 6,
              background: loading || !canCreateRepos ? "#A0B8FF" : hovered ? T.accentHover : T.accent,
              color: "#fff",
              fontFamily: T.dm,
              fontSize: 14,
              fontWeight: 700,
